...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "enter6DigitOtp":
            MessageLookupByLibrary.simpleMessage("Введите 6 цифр из СМС"),
        ...
        "otpVerification":
            MessageLookupByLibrary.simpleMessage("Авторизация по СМС"),
        "phoneNumber": MessageLookupByLibrary.simpleMessage("Номер телефона"),
        "signUp": MessageLookupByLibrary.simpleMessage("Войди"),
        "submit": MessageLookupByLibrary.simpleMessage("Подтвердить"),
        "toStartPlay":
            MessageLookupByLibrary.simpleMessage("чтобы начать слушать"),
        "yourPhoneNumber":
